...
const Notification = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen">
      <div className="container mx-auto max-w-4xl space-y-8 h-screen">
        <h1 className="text-2xl sm:text-3xl font-bold trackinng-tight mb-6">
          Notifications{" "}
        </h1>
        ...
        {isLoading ? (
          ...
          <>
            ...
            {/* accepteed friends notification */}
            {acceptFriendRequest && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
